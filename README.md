...
Результат работы: Снова запускаем команду sudo -u postgres psql, затем подключаемся к базе данных emp_db -> \c emp_db. Дальше выводи поля таблицы employee. SELECT * FROM employee;

<img width="1654" height="1116" alt="Screenshot from 2025-07-25 12-34-51" src="https://github.com/user-attachments/assets/5c6be4b9-4931-4cd1-b455-c44e13354582" />
